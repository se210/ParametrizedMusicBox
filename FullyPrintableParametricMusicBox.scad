...
//Mario
teethNotes="G 4C 5Db5D 5E 5F 5Gb5G 5A 5Bb5B 5C 6D 6E 6F 6G 6A 6";
//pokemon center
//teethNotes = "G 3C 4D 4G 4G 5B 5C 6D 6E 6F 6G 6";
...
//Mario
//pins = "";
//pokemon center
pins = "";
...
module MusicBoxHoles()
{
	rotate([180,0,0])
	translate([0, -(2*gearH+3*gear_gap), 0])
	for (x=[0:2])
	{
